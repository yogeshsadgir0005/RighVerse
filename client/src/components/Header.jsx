    ...
    <img src={rightverseLogo} className='h-24 w-24' alt="RightVerse Logo" />
     ...
     {navItems.map((item) => (
          ...
          <div className="flex items-center gap-4 shrink-0">
            ...
            <div className="hidden md:flex animate-right-pic w-22 h-22 rounded-full bg-[#E9E3D9] border-2 border-[#B89A6A] shadow-sm items-center justify-center overflow-hidden">
               <img 
                  src={stambhlogo} 
                  alt="Ashoka Emblem" 
